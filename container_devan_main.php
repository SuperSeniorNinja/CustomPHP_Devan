...
<style>
    ...
    .table-scroll tbody tr:last-child th, tr:last-child > td {
    ...
    .bootstrap-datetimepicker-widget tbody tr:last-child th, tr:last-child > td {
        border-bottom: 0;
    }
    ...
    <div class="content-wrapper">
        <div class="content-header">
            <div class="container-fluid">
                <div class="row mb-2">
                    <div class="col-sm-4">
                        <h1 class="m-0" style="display: inline">Deeside Devanning / Vanning Schedule<?php// echo $page_name; ?></h1>
                    </div>
                    ...
                    <div class="col-sm-5" style="text-align: right;">
                        ...
                        <input class="form-control" type="text" id="year_month" name="year_month"
                               style="display: inline-block; width: 200px;" value="<?php echo date('m/Y'); ?>">
